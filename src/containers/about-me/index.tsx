              ...
              <div className="relative flex flex-1 flex-col gap-6">
                ...
                <div className="space-y-6 flex-1 flex flex-col items-center justify-center">
                  <h3 className="pt-0.5 text-lg font-bold text-balance text-black md:text-4xl dark:text-white">
                    Passionate about technology and back end craftsmanship.
                  </h3>
...
const networks = [
  {
    ...
    href: "https://github.com/Tranducvu1",
  },
  {
    name: "Linkedin",
    icon: IconBrandLinkedin,
    href: "https://www.linkedin.com/in/tr%E1%BA%A7n-%C4%91%E1%BB%A9c-v%C5%A9-326ab8228/",
  },
  {
    name: "Email",
    icon: IconMail,
    href: "mailto:tranducvuwork@gmail.com",
  },
  {
    name: "Facebook",
    icon: IconBrandFacebook,
    href: "https://www.facebook.com/oxitociin/",
  },
  {
    name: "Instagram",
    icon: IconBrandInstagram,
    href: "https://www.instagram.com/_trvu_/",
  },
]
...
const KeySkills = () => {
  ...
  const skills = [
    ...
    {
      name: "RESTful APIs",
      color: "rgb(255 237 213)", // orange-ish
      darkColor: "rgba(249, 115, 22, 0.2)",
    },
    {
      name: "Database Design (MySQL/PostgreSQL)",
      color: "rgb(254 243 199)", // soft yellow
      darkColor: "rgba(234, 179, 8, 0.2)",
    },
    {
      name: "Authentication & JWT",
      color: "rgb(248 250 252)", // very light gray-blue
      darkColor: "rgba(71, 85, 105, 0.2)",
    },
    {
      name: "Docker",
      color: "rgb(207 250 254)", // cyan
      darkColor: "rgba(6, 182, 212, 0.2)",
    },
    {
      name: "CI/CD & DevOps Basics",
      color: "rgb(244 244 245)", // light gray
      darkColor: "rgba(113, 113, 122, 0.2)",
    },
    {
